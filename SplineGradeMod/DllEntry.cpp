...
TCHAR* GetString(int id);		// forward declaration -- was missing, causing C3861 at LibDescription() below,
// since GetString() is only DEFINED at the bottom of this file (after its first use).
...
__declspec( dllexport ) ClassDesc* LibClassDesc(int i)
{
	switch(i)
	{
		case 0: return GetSplineGradeModDesc();
		default: return 0;
	}
}
